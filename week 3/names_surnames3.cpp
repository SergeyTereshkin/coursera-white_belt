...
const string BuildJoinedName(vector<string> names) {
...
class Person {
public:
    Person(const string& new_first_name, const string& new_last_name, const int& new_birth_year)
    {
        birth_year = new_birth_year;
        first_names[birth_year] = new_first_name;
        last_names[birth_year] = new_last_name;
    }
